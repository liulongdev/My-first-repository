...
{
    if (!self.pasteDelegate || ([self.pasteDelegate respondsToSelector:@selector(composerTextView:shouldPasteWithSender:)] &&  [self.pasteDelegate composerTextView:self shouldPasteWithSender:sender])) {
        [super paste:sender];
    }
}

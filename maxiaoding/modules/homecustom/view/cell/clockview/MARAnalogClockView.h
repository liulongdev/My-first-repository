...
@protocol MARAnalogClockDelegate;

@interface MARAnalogClockView : UIView
...
@property (nonatomic, assign) IBOutlet id <MARAnalogClockDelegate> delegate;
...
@protocol MARAnalogClockDelegate <NSObject>
...
- (void)currentTimeOnClock:(MARAnalogClockView *)clock Hours:(NSString *)hours Minutes:(NSString *)minutes Seconds:(NSString *)seconds;
...
- (NSString *)dateFormatterForClock:(MARAnalogClockView *)clock;
...
- (NSString *)timeForClock:(MARAnalogClockView *)clock;
...
- (UIColor *)analogClock:(MARAnalogClockView *)clock graduationColorForIndex:(NSInteger)index;
...
- (CGFloat)analogClock:(MARAnalogClockView *)clock graduationAlphaForIndex:(NSInteger)index;
...
- (CGFloat)analogClock:(MARAnalogClockView *)clock graduationWidthForIndex:(NSInteger)index;
...
- (CGFloat)analogClock:(MARAnalogClockView *)clock graduationLengthForIndex:(NSInteger)index;
...
- (CGFloat)analogClock:(MARAnalogClockView *)clock graduationOffsetForIndex:(NSInteger)index;
...
- (void)clockDidBeginLoading:(MARAnalogClockView *)clock;
...
- (void)clockDidFinishLoading:(MARAnalogClockView *)clock;
